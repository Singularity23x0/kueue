...
[Set Up Dynamic Resource Allocation](/v0.17/docs/tasks/manage/setup_dra).
...
[WaitForPodsReady](/v0.17/docs/tasks/manage/setup_wait_for_pods_ready/) feature
...
For setup instructions, see
[Set Up Dynamic Resource Allocation](/v0.17/docs/tasks/manage/setup_dra/#set-up-counter-based-quota-partitionable-devices).
