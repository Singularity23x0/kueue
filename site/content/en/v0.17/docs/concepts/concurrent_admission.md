...
[Workload](/v0.17/docs/concepts/workload), each constrained to a different
[ResourceFlavor](/v0.17/docs/concepts/resource_flavor). This lets a Workload start on
...
- [Set up Concurrent Admission](/v0.17/docs/tasks/manage/setup_concurrent_admission).
- Learn about [ClusterQueue flavor order](/v0.17/docs/concepts/cluster_queue#flavors-and-resources).
- Read the [Workload concept](/v0.17/docs/concepts/workload) to understand Parent and
  Variant Workloads.
