...
[Topology-Aware Scheduling (TAS)](/v0.17/docs/concepts/topology_aware_scheduling)
in a Kubernetes cluster with Kueue enabled. The examples use a batch Job, but
the same annotations work with any
[workload type that Kueue supports](/v0.17/docs/concepts/workload).
...
[Topology-Aware Scheduling concepts](/v0.17/docs/concepts/topology_aware_scheduling).
...
- Your administrator has
  [configured TAS](/v0.17/docs/concepts/topology_aware_scheduling#admin-facing-apis)
...
[Change the feature gates configuration](/v0.17/docs/installation/#change-the-feature-gates-configuration).
...
{{< include "v0.17/examples/tas/sample-job-required.yaml" "yaml" >}}
...
{{< include "v0.17/examples/tas/sample-job-unconstrained.yaml" "yaml" >}}
...
Internally, Kueue creates a corresponding [Workload](/v0.17/docs/concepts/workload)
...
- **Balanced placement** - the alpha `TASBalancedPlacement` feature gate makes
  ...
  [Balanced Placement](/v0.17/docs/concepts/topology_aware_scheduling#balanced-placement).
- **PodSet groups** - co-locate multiple PodSets of a single workload in the
  ...
  [Configure Topology Aware Scheduling for LeaderWorkerSet](/v0.17/docs/tasks/run/leaderworkerset#configure-topology-aware-scheduling)
...
- **Multi-layer topology** - express slice constraints at up to three
  ...
  [Multi-Layer Topology](/v0.17/docs/concepts/topology_aware_scheduling#multi-layer-topology)
...
[troubleshooting guide](/v0.17/docs/tasks/troubleshooting).
