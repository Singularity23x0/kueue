...
Enable SparkApplication integration in Kueue. You can [modify Kueue configurations from installed releases](/v0.17/docs/installation#install-a-custom-configured-released-version) to include `sparkoperator.k8s.io/sparkapplication` as an allowed workload.

Enable the `SparkApplicationIntegration` feature gate. Check the [installation](/v0.17/docs/installation/#change-the-feature-gates-configuration) guide for details on feature gate configuration.
