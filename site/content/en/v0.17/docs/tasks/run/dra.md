...
[Dynamic Resource Allocation concepts](/v0.17/docs/concepts/dynamic_resource_allocation).
...
- Your administrator has
  [set up DRA support in Kueue](/v0.17/docs/tasks/manage/setup_dra).
...
[running a regular Job](/v0.17/docs/tasks/run/jobs). You must set the
...
{{< include "v0.17/examples/dra/sample-dra-rct-job.yaml" "yaml" >}}
...
{{< include "v0.17/examples/dra/sample-dra-extended-resource-job.yaml" "yaml" >}}

### Using partitionable devices

If your administrator has configured
[counter-based quota](/v0.17/docs/tasks/manage/setup_dra/#set-up-counter-based-quota-partitionable-devices),
...
{{< include "v0.17/examples/dra/sample-dra-counter-job.yaml" "yaml" >}}
...
[DRA setup](/v0.17/docs/tasks/manage/setup_dra).
