...
This page shows how to set up [Concurrent Admission](/v0.17/docs/concepts/concurrent_admission)
for a ClusterQueue.
...
- [Kueue is installed](/v0.17/docs/installation) in version 0.18 or later.
...
Follow the
[feature gates configuration instructions](/v0.17/docs/installation/#change-the-feature-gates-configuration)
...
{{< include "v0.17/examples/admin/concurrent-admission-setup.yaml" "yaml" >}}
...
- Read the [Concurrent Admission concept](/v0.17/docs/concepts/concurrent_admission).
- Read the [API reference](/v0.17/docs/reference/kueue.v1beta2/#kueue-x-k8s-io-v1beta2-ConcurrentAdmissionPolicy)
