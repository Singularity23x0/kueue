...
[Run Workloads With DRA Devices](/v0.17/docs/tasks/run/dra).
...
{{< include "v0.17/examples/dra/sample-dra-queues.yaml" "yaml" >}}
...
[custom configuration installation instructions](/v0.17/docs/installation/#install-a-custom-configured-released-version).
...
{{< include "v0.17/examples/dra/sample-dra-counter-queues.yaml" "yaml" >}}
...
[WaitForPodsReady](/v0.17/docs/tasks/manage/setup_wait_for_pods_ready/) provides a
...
DRA workloads are supported with [MultiKueue](/v0.17/docs/concepts/multikueue).
