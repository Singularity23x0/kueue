...
- [Kueue is installed](/v0.17/docs/getting-started/installation).
...
{{< include "v0.17/examples/getting-started/quick-start-setup.yaml" "yaml" >}}
...
{{< include "v0.17/examples/getting-started/quick-start-job.yaml" "yaml" >}}
...
Kueue creates a [Workload](/v0.17/docs/concepts/workload) object for every managed Job.
...
- Learn about [Kueue concepts](/v0.17/docs/concepts) such as ClusterQueues, Workloads, and preemption.
- Configure [resource quotas and fair sharing](/v0.17/docs/tasks/manage/administer_cluster_quotas) for multiple teams.
- Run other workload types: [Kubeflow jobs](/v0.17/docs/tasks/run/kubeflow/), [RayJobs](/v0.17/docs/tasks/run/rayjobs/), [plain Pods](/v0.17/docs/tasks/run/plain_pods/).
