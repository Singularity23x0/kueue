...
更多信息，请参见 [Kueue 概述](/zh-cn/v0.17/docs/overview)。
...
目标[本地队列](/zh-cn/v0.17/docs/concepts/local_queue)应在 Deployment 配置的 `metadata.labels` 部分中指定。
...
有关 `lendingLimit` 的更多详细信息，请参见 [ClusterQueue 页面](/zh-cn/v0.17/docs/concepts/cluster_queue#lendinglimit)。
