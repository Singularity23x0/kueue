...
本指南适用于[批处理用户](/zh-cn/v0.17/docs/tasks#batch-user)他们具有基本的 Python 与 Kubernetes 交互经验。
...
最后，有关如何使用 YAML 在 Python 之外完成此操作的说明，请参见[运行 Flux MiniCluster](/zh-cn/v0.17/docs/tasks/run/external_workloads/flux_miniclusters/)。
