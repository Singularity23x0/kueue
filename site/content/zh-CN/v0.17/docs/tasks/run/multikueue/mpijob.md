...
请查阅 [MultiKueue 安装指南](/zh-cn/v0.17/docs/tasks/manage/setup_multikueue)了解如何正确设置 MultiKueue 集群。
...
详见 [与 MPI Operator 协同工作](/zh-cn/v0.17/docs/tasks/run/multikueue/kubeflow#working-alongside-mpi-operator)。
{{% /alert %}}
...
完成设置后，你可以通过运行 MPIJob [`sample-mpijob.yaml`](/zh-cn/v0.17/docs/tasks/run/kubeflow/mpijobs/#sample-mpijob)进行测试。
