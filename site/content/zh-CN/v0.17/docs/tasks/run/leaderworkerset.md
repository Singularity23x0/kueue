...
本指南适用于对 Kueue 有基本了解的[服务用户](/zh-cn/v0.17/docs/tasks#serving-user)。
有关更多信息，请参见 [Kueue 概述](/zh-cn/v0.17/docs/overview)。

## 开始之前 {#before-you-begin}

1. `leaderworkerset.x-k8s.io/leaderworkerset` 集成默认启用。

2. 对于 Kueue v0.15 及更早版本，学习如何[安装 Kueue 并使用自定义管理器配置](/zh-cn/v0.17/docs/installation/#install-a-custom-configured-released-version)，
   ...
   有关配置详情，请参阅[运行普通 Pod](/zh-cn/v0.17/docs/tasks/run/plain_pods/#before-you-begin)。
   {{% /alert %}}
   
3. 查看[管理集群配额](/zh-cn/v0.17/docs/tasks/manage/administer_cluster_quotas)了解初始 Kueue 设置的详细信息。
...
目标[本地队列](/zh-cn/v0.17/docs/concepts/local_queue)应在 LeaderWorkerSet 配置的 `metadata.labels` 部分指定。
...
- [为拓扑感知调度配置集群](/zh-cn/v0.17/docs/concepts/topology_aware_scheduling)。
...
有关在 MultiKueue 环境中运行 LeaderWorkerSet 的详细信息，请查看 [MultiKueue](/zh-cn/v0.17/docs/tasks/run/multikueue/leaderworkerset)。
