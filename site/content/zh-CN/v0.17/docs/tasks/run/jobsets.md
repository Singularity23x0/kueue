...
本指南适用于[批处理用户](/zh-cn/v0.17/docs/tasks#batch-user)，他们需要对 Kueue 有基本的了解。更多信息，请参见 [Kueue 概览](/zh-cn/v0.17/docs/overview)。

## 开始之前 {#before-you-begin}

1. 请参见[管理集群配额](/zh-cn/v0.17/docs/tasks/manage/administer_cluster_quotas)了解初始 Kueue 设置的详细信息。
...
目标[本地队列](/zh-cn/v0.17/docs/concepts/local_queue)应在 JobSet 配置的 `metadata.labels` 部分指定。
...
请参见 [Multikueue](/zh-cn/v0.17/docs/tasks/run/multikueue) 了解在 MultiKueue 环境中运行 JobSet 的详细信息。
