...
欲了解更多详情，请参见 [Kueue 概述](/zh-cn/v0.17/docs/overview)。
...
查阅[管理集群配额](/zh-cn/v0.17/docs/tasks/manage/administer_cluster_quotas)，
了解初始集群设置的详细信息。
...
你可以[修改已安装版本的 Kueue 配置](/zh-cn/v0.17/docs/installation#install-a-custom-configured-released-version)，
...
目标[本地队列](/zh-cn/v0.17/docs/concepts/local_queue)应当在 PyTorchJob
