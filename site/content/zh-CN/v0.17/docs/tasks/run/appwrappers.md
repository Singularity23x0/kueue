...
本指南适用于对 Kueue 有基本了解的[批用户](/zh-cn/v0.17/docs/tasks#batch-user)。更多信息请参见 [Kueue 概述](/zh-cn/v0.17/docs/overview)。

## 开始之前 {#before-you-begin}

请查阅[管理集群配额](/zh-cn/v0.17/docs/tasks/manage/administer_cluster_quotas)以了解 Kueue 的初始设置详情。
...
目标[本地队列](/zh-cn/v0.17/docs/concepts/local_queue)应在 AppWrapper 的 `metadata.labels` 部分指定。
