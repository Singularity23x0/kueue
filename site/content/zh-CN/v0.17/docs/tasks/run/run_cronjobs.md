...
本页面的受众是[批处理用户](/zh-cn/v0.17/docs/tasks#batch-user)。
...
- [Kueue 安装文档](/zh-cn/v0.17/docs/installation)。
- 集群已配置 [配额](/zh-cn/v0.17/docs/tasks/manage/administer_cluster_quotas)。
...
[ClusterQueue](/zh-cn/v0.17/docs/concepts/cluster_queue) 定义了队列的配额。
...
内部，Kueue 将为每次 Job 运行创建一个对应 [Workload](/zh-cn/v0.17/docs/concepts/workload)
其名称与 Job 匹配。
...
你还可以[监控 Workload 的状态](/zh-cn/v0.17/docs/tasks/run/jobs#3-optional-monitor-the-status-of-the-workload)。
