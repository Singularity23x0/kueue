...
对于在其定义中使用 `PodSpecTemplates` 的工作负载，这提供了一种比[构建自定义集成](/zh-cn/v0.17/docs/tasks/dev/integrate_a_custom_job)
...
2. 遵循[运行 AppWrapper](/zh-cn/v0.17/docs/tasks/run/appwrappers/#before-you-begin)
