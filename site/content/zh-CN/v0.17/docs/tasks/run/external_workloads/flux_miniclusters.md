...
目标[本地队列](/zh-cn/v0.17/docs/concepts/local_queue)应在 MiniCluster
...
有关在 Python 中执行此操作的等效说明，请参阅[运行 Python 作业](/zh-cn/v0.17/docs/tasks/run/python_jobs/#flux-operator-job)。
