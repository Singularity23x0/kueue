...
欲了解更多信息，请参见 [Kueue 概述](/zh-cn/v0.17/docs/overview)。

目前，Kueue 不直接支持 Argo Workflow 的 [Workflow](https://argo-workflows.readthedocs.io/en/latest/workflow-concepts/) 资源，
但你可以利用 Kueue [管理普通 Pod](/zh-cn/v0.17/docs/tasks/run/plain_pods) 的能力来集成它们。

## 开始之前

1. 学习如何[使用自定义管理器配置安装 Kueue](/zh-cn/v0.17/docs/installation/#install-a-custom-configured-released-version)。

2. 遵循[运行普通 Pod](/zh-cn/v0.17/docs/tasks/run/plain_pods/#before-you-begin)
...
如果你希望整个工作流针对单个[本地队列](/zh-cn/v0.17/docs/concepts/local_queue)，
...
如果你希望针对工作流的每一步使用不同的[本地队列](/zh-cn/v0.17/docs/concepts/local_queue)，
