...
我们将演示如何基于 [Plain Pod](/zh-cn/v0.17/docs/tasks/run/plain_pods) 集成，
...
3. 查看[管理员集群配额](/zh-cn/v0.17/docs/tasks/manage/administer_cluster_quotas/)以获取初始 Kueue 步骤的详细信息。
...
如果你希望每个任务都针对一个单独的[本地队列](/zh-cn/v0.17/docs/concepts/local_queue)，
