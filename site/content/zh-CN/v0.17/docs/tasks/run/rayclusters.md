...
本指南适用于[批处理用户](/zh-cn/v0.17/docs/tasks#batch-user)，他们需要对 Kueue 有基本的了解。
...
2. 请参见 [Administer cluster quotas](/zh-cn/v0.17/docs/tasks/manage/administer_cluster_quotas)
   了解初始 Kueue 设置的详细信息。
...
目标 [本地队列](/zh-cn/v0.17/docs/concepts/local_queue)应在 RayCluster 配置的 `metadata.labels` 部分指定。
