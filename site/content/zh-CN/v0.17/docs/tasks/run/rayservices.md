...
本指南面向对 Kueue 有基本了解的、[对外提供服务的用户](/zh-cn/v0.17/docs/tasks#serving-user)。
...
2. 请参见 [管理集群配额](/zh-cn/v0.17/docs/tasks/manage/administer_cluster_quotas)了解初始 Kueue 设置的详细信息。
...
目标 [本地队列](/zh-cn/v0.17/docs/concepts/local_queue)应在 RayService 配置的 `metadata.labels`
