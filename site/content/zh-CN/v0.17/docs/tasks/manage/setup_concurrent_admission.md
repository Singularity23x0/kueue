...
本文介绍如何为 ClusterQueue 设置[并发准入](/v0.17/docs/concepts/concurrent_admission)。
...
- Kubernetes 集群正在运行。
- `kubectl` 命令行工具可以访问集群。
- 已安装 0.18 或更高版本的 [Kueue](/v0.17/docs/installation)。

## 启用特性门控 {#enable-the-feature-gate}

`ConcurrentAdmission` 是 alpha 特性，默认关闭。

请按照[特性门控配置说明](/v0.17/docs/installation/#change-the-feature-gates-configuration)，
...
- 阅读[并发准入概念](/v0.17/docs/concepts/concurrent_admission)。
