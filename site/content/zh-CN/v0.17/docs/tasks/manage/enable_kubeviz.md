...
有关完整说明，请参阅 [Helm chart 安装指南](/zh-cn/v0.17/docs/installation/#install-by-helm)。
{{% /alert %}}
...
有关安装 Kueue 的更多信息，请参阅[安装](/zh-cn/v0.17/docs/installation)。
...
- 探索更多[任务](/zh-cn/v0.17/docs/tasks)
- 了解[概念](/zh-cn/v0.17/docs/concepts)
