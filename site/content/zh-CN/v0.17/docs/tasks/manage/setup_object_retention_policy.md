...
按照此处描述的说明[安装自定义配置的发布版本](/zh-cn/v0.17/docs/installation#install-a-custom-configured-released-version)，
并通过添加以下字段扩展配置：
...
**配置** Kueue 使用 1 分钟的保留策略，并启用 [waitForPodsReady](/zh-cn/v0.17/docs/tasks/manage/setup_wait_for_pods_ready)：
...
1. **配置** Kueue 使得 [Deployment](/zh-cn/v0.17/docs/installation#install-a-custom-configured-released-version)
    可使用超过节点容量的资源：
