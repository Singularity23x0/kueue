...
[ClusterQueue](/zh-cn/v0.17/docs/concepts/cluster_queue/#flavors-and-resources)
...
并遵循[借用和借出限制](/zh-cn/v0.17/docs/reference/kueue.v1beta1/#kueue-x-k8s-io-v1beta1-ResourceQuota)。
