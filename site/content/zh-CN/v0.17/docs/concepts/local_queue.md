...
`LocalQueue` 指向一个 [`ClusterQueue`](/zh-cn/v0.17/docs/concepts/cluster_queue)，
并从中分配资源以运行其工作负载。
...
- 通过本地队列启动[工作负载](/zh-cn/v0.17/docs/concepts/workload)
- 阅读 `LocalQueue` 的 [API 参考](/zh-cn/v0.17/docs/reference/kueue.v1beta1/#kueue-x-k8s-io-v1beta1-LocalQueue)
