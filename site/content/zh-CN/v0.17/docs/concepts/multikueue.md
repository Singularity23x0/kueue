...
请参阅[安装指南](/zh-cn/v0.17/docs/installation/#change-the-feature-gates-configuration)。
{{% /alert %}}
...
## 提交作业
在[配置好的 MultiKueue 环境](/zh-cn/v0.17/docs/tasks/manage/setup_multikueue)中，
你可以向管理集群提交任何 MultiKueue 支持的作业，目标是为 Multikueue 配置的 ClusterQueue。
Kueue 将作业委派给配置的工作集群，无需任何额外的配置更改。

## 接下来是什么？
- 学习如何[设置 MultiKueue 环境](/zh-cn/v0.17/docs/tasks/manage/setup_multikueue/)
- 学习如何在 MultiKueue 环境中[运行作业](/zh-cn/v0.17/docs/tasks/run/multikueue)。
