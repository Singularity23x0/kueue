...
func (in *ClusterQueueSpec) DeepCopyInto(out *ClusterQueueSpec) {
	*out = *in
	...
	in.QuotaAutomationConfig.DeepCopyInto(&out.QuotaAutomationConfig)
}
...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *QuotaAutomationConfig) DeepCopyInto(out *QuotaAutomationConfig) {
	*out = *in
	if in.Steps != nil {
		in, out := &in.Steps, &out.Steps
		*out = make([]QuotaAutomationStep, len(*in))
		copy(*out, *in)
	}
	if in.ConfigMap != nil {
		in, out := &in.ConfigMap, &out.ConfigMap
		*out = make(map[QuotaAutomationParameter]string, len(*in))
		for key, val := range *in {
			(*out)[key] = val
		}
	}
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new QuotaAutomationConfig.
func (in *QuotaAutomationConfig) DeepCopy() *QuotaAutomationConfig {
	if in == nil {
		return nil
	}
	out := new(QuotaAutomationConfig)
	in.DeepCopyInto(out)
	return out
}
